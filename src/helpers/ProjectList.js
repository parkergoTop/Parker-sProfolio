...
export const projectList = [
    {title:"Quizzical", 
    images: [ React1P1, React1P2, React1P3, React1P4, React1P5,React1P6], 
    skills: "Techniques: HTML CSS/SASS Javascript React",
    github: "https://github.com/parkergoTop/Quizzical-"}, 
